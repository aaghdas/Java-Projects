...
import static de.gfn.kursProjekte.botGame.Direction.*;
...
public class Game {
    ...
    private void start() {
        ...
        app: while(true) {
            ...
            System.out.println(UiUtils.KEYS);
            ...
            if(input.equals("exit")) {
                ...
                for (String d : directions) {
                    ...
                    if(d.equals("d")) {
                        ...
                        System.out.println(UiUtils.ERR_INPUT);
                    }
                }
                board.print();
            }
        ...
        System.out.println(UiUtils.THE_END);
